...
export default function Hero() {
  return (
    <section className="relative h-screen w-full bg-white overflow-hidden flex items-center justify-center snap-start snap-always">
      ...
      <div className="absolute top-24 right-8 md:top-28 md:right-12 lg:top-32 lg:right-16 pointer-events-none z-10">
        <div className="flex flex-col gap-0 font-medium text-sm md:text-base lg:text-lg tracking-tight leading-snug text-black">
      ...
      <div className="absolute bottom-8 left-8 md:bottom-12 md:left-12 lg:bottom-16 lg:left-16 max-w-sm md:max-w-md pointer-events-none z-10">
        <p className="m-0 font-medium text-sm md:text-base lg:text-lg tracking-tight leading-snug text-black">
